 ...
 * Description: (Writing a program that computes taxes from four different filing status using if-else statements.) <br />
 * Due: 2/06/2022 <br />
...
public class HW3 {
	...
	public static void main(String[] args) {
	    ...
	    //Prompt the user and Declare the variable
	    ...
	    if (status == 0) { 
		    ...
		    else if (status == 1) { //Compute Married Filing Jointly Taxes
		     if (income <= 18650)
		    	tax = income * 0.10;
			...
			else if (status == 2) { //Compute Married Filing Separately Taxes
			 if (income <= 9325)
			    	tax = income * 0.10;
			    	else if (income <= 37950)
			    	tax = 9325 * 0.10 + (income - 9325) * 0.15; 
			 	      ...
			 	      tax = 9325 * 0.10 + (37950 - 9325) * 0.15 +
			 	        ...
			 	        tax = 9325 * 0.10 + (37950 - 9325) * 0.15 +
			 	          (116675 - 37950) * 0.25 + (income - 76550) * 0.28;
		    ...
		    else if (status == 3) { //Compute Head of Household Filing Taxes
					if (income <= 13350)
			    	tax = income * 0.10;
			    	...
			    	tax = 13350 * 0.10 + (income - 13350) * 0.15; 
			 	      ...
			 	      tax = 13350 * 0.10 + (50800 - 13350) * 0.15 +
			 	        ...
			 	        tax = 13350 * 0.10 + (50800 - 13350) * 0.15 +
			 	          (212500 - 50800) * 0.25 + (income - 131200) * 0.28;
			 	     else if (income <= 416700)
			 	        tax = 13350 * 0.10 + (50800 - 13350) * 0.15 +
		    ...
		    else  { //Prompt User Error Message If Invalid Status
